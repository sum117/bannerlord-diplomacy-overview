namespace DiplomacyOverview.Core
{
    ...
    /// docs/research/04-gauntlet-ui-playbook.md §F (mockup-derived); CallToWar had no mockup color,
    /// so it gets a steel blue distinct from the other three.
    /// </summary>
    public static class RelationPalette
    {
        public const string WarColor = "#C0392BFF";
        public const string AllianceColor = "#4E9B47FF";
        public const string NonAggressionPactColor = "#D4A017FF";
